 ...
 */
final class Version20211223175043 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE carrinho_produto (carrinho_id INT NOT NULL, produto_id INT NOT NULL, INDEX IDX_6D2BC499105CFD56 (produto_id), INDEX IDX_6D2BC499D363F3C2 (carrinho_id), PRIMARY KEY(carrinho_id, produto_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE linhas_carrinho (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
