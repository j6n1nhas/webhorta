 ...
 */
final class Version20211223175405 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE carrinho_produto (carrinho_id INT NOT NULL, produto_id INT NOT NULL, INDEX IDX_6D2BC499D363F3C2 (carrinho_id), INDEX IDX_6D2BC499105CFD56 (produto_id), PRIMARY KEY(carrinho_id, produto_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
