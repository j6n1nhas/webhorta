...
/* login.html */
class __TwigTemplate_c9535ffd79ae5b8e77cf90a3d3c701cc8ea347e263214b2598aedacc05097501 extends Template
{
    private $source;
    private $macros = [];
...
<section class=\"container-sm formulario\">
    <form action=\"";
        // line 14
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("login");
        echo "\" method=\"POST\" novalidate>
        <label for=\"email\" class=\"form-label\">Email</label>
        <input type=\"email\" name=\"_username\" id=\"email\" class=\"form-control mb-3\" required>
        <label for=\"password\" class=\"form-label\">Password</label>
        <input type=\"password\" name=\"_password\" id=\"password\" class=\"form-control mb-3\" required>
        <input type=\"hidden\" name=\"_target_path\" value=\"/produtos\"/>
...
";
    ...
    {
        return array (  151 => 20,  142 => 14,  138 => 12,  128 => 11,  117 => 9,  107 => 8,  94 => 6,  84 => 5,  71 => 3,  61 => 2,  38 => 1,);
    }
...
{% endblock %}
{% block conteudo %}
<h2 class=\"text-center fs-1 m-4\">Formulário de Login</h2>
<section class=\"container-sm formulario\">
    <form action=\"{{ path('login') }}\" method=\"POST\" novalidate>
        <label for=\"email\" class=\"form-label\">Email</label>
        <input type=\"email\" name=\"_username\" id=\"email\" class=\"form-control mb-3\" required>
        <label for=\"password\" class=\"form-label\">Password</label>
        <input type=\"password\" name=\"_password\" id=\"password\" class=\"form-control mb-3\" required>
...
{% endblock %}", "login.html", "/home/johnny/Documents/Cursos/ISLA/ANO 2/SEMESTRE 3/Programação para a Web/Projeto/Project_root/my_project/templates/login.html");
    }
}
