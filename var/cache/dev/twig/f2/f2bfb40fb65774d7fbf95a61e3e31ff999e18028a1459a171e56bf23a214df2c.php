...
/* produto.html */
class __TwigTemplate_08839330fe04f76a74c2c807d96682872bf348ddf13715a945fb9a6cda948375 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base.html", "produto.html", 1);
...
";
    ...
    public function block_conteudo($context, array $blocks = [])
    {
        ...
        // line 15
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 15, $this->source); })()), "request", [], "any", false, false, false, 15), "getPathInfo", [], "any", false, false, false, 15) == "/admin/produtos/add")) {
            // line 16
            echo "    <h2 class=\"fs-2 mt-3 text-center\">Inserir produto</h2>
";
        } else {
            // line 18
            echo "    <h2 class=\"fs-2 mt-3 text-center\">Alterar produto</h2>
";
        }
        // line 20
        echo "<div class=\"container-fluid formulario mt-5 p-5\">
    ";
        // line 21
...
";
    ...
    {
        return array (  150 => 22,  146 => 21,  143 => 20,  139 => 18,  135 => 16,  133 => 15,  123 => 14,  105 => 11,  92 => 8,  82 => 7,  71 => 4,  61 => 3,  38 => 1,);
    }
...
{% block conteudo %}
{% if app.request.getPathInfo == '/admin/produtos/add' %}
    <h2 class=\"fs-2 mt-3 text-center\">Inserir produto</h2>
{% else %}
    <h2 class=\"fs-2 mt-3 text-center\">Alterar produto</h2>
{% endif %}
<div class=\"container-fluid formulario mt-5 p-5\">
    {{ form(form) }}
    <a href=\"{{ path('admin_index') }}\" class=\"btn btn-warning\">Cancelar</a>
</div>
{% endblock %}", "produto.html", "/home/johnny/Documents/Cursos/ISLA/ANO 2/SEMESTRE 3/Programação para a Web/Projeto/Project_root/templates/produto.html");
    }
}
