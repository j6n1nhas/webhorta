...
class getAdminControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.DBP0jXZ'] ?? $container->load('get_ServiceLocator_DBP0jXZService'))->withContext('App\\Controller\\AdminController', $container));
