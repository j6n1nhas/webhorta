...
class getConsole_Command_CachePoolDeleteService extends App_KernelProdContainer
{
    ...
    {
        $container->privates['console.command.cache_pool_delete'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolDeleteCommand(($container->services['cache.global_clearer'] ?? $container->load('getCache_GlobalClearerService')), [0 => 'cache.app', 1 => 'cache.system', 2 => 'cache.validator', 3 => 'cache.serializer', 4 => 'cache.annotations', 5 => 'cache.property_info', 6 => 'doctrine.result_cache_pool', 7 => 'doctrine.system_cache_pool', 8 => 'cache.property_access', 9 => 'cache.validator_expression_language', 10 => 'cache.security_expression_language', 11 => 'cache.webpack_encore', 12 => 'api_platform.cache.route_name_resolver', 13 => 'api_platform.cache.identifiers_extractor', 14 => 'api_platform.cache.subresource_operation_factory', 15 => 'api_platform.cache.metadata.resource', 16 => 'api_platform.cache.metadata.property']);
