...
class getAdminControllerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator._13vCgV'] ?? $container->load('get_ServiceLocator_13vCgVService'))->withContext('App\\Controller\\AdminController', $container));
